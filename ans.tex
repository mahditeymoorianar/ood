...
\fancyhead[L]{فاز ۱ پروژه‌ی درس طرّاحی شئ‌گرا\\شبکه‌ی اجتماعی قاصدک}
...
\title{
    ...
    {\huge فاز ۱ پروژه‌ی طرّاحی سیستم‌های شئ‌گرا}\\
    \vspace{5mm}
...
\begin{document}
    ...
    \titr{برنامه‌ی زمان‌بندی فاز ۲}
        \begin{figure}[H]
            \centering
            \includegraphics*[width = 0.7\textwidth]{files/figures/phase2timing/page1.png}
            \includegraphics*[width = 0.7\textwidth]{files/figures/phase2timing/page2.png}
            \caption{برنامه‌ی زمانبندی‌شده‌ی فاز ۲}
        \end{figure}
            % \begin{figure}[H]
    %     \centering
